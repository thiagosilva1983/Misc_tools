...
st.info(
    "This is a standalone REV B demo module. It uses mock data now, "
    "and you can later replace the mock functions with your real SOS Inventory fetch logic."
)

col1, col2 = st.columns([1, 1])
with col1:
    run_clicked = st.button("Run MRP", type="primary", use_container_width=True, key="mrp_run_app")
with col2:
    st.button("Refresh Mock Data", use_container_width=True, key="mrp_refresh_app")
...
st.caption(
    ...
    "get_purchase_orders() with your real SOS Inventory functions."
)
